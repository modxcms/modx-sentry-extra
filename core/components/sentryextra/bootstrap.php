...
$modx->services->add('sentryextra', function($c) use ($modx) {
    return new \SentryExtra\v3\SentryExtra($modx);
});

// Load packages model, uncomment if you have DB tables
//$modx->addPackage('SFTech\Model', $namespace['path'] . 'src/', null, 'SFTech\\');
