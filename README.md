...
### MODX 2.x
```php
$sentry = $modx->getService('sentry', 'Sentry', $modx->getOption('sentry.core_path', null, $modx->getOption('core_path') . 'components/sentry/') . 'model/sentry/');
$sentry->log(xPDO::LOG_LEVEL_ERROR, 'This is a test error message');
```
